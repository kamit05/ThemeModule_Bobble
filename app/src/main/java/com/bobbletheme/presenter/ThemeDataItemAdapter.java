...
public class ThemeDataItemAdapter extends RecyclerView.Adapter<ThemeDataItemAdapter.ViewHolder> {
    ...
    public ThemeDataItemAdapter(Context context, Themes[] imageUrls, ThemeDataAdapter themeDataAdapter, boolean isMyTheme) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        try {
              if (isMyTheme) {
                  if (i == 0){
                      viewHolder.draweeView.setImageURI(ThemeUtils.bitmapToUriConverter(context, lastGalleryImage));
                      viewHolder.draweeView.setImageAlpha(R.color.opequeOverlay);
